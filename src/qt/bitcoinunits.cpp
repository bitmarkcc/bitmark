...
{
    switch (unit) {
    case Unit::BTC: return QString("BTM");
    case Unit::mBTC: return QString("mBTM");
    case Unit::uBTC: return QString::fromUtf8("µBTM (bits)");
...
{
    switch (unit) {
    case Unit::BTC: return QString("Bitmarks");
    case Unit::mBTC: return QString("Milli-Bitmarks (1 / 1" THIN_SP_UTF8 "000)");
    case Unit::uBTC: return QString("Micro-Bitmarks (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
