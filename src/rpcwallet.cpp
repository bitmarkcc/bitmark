...
Value getnewaddress(const Array& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "\nReturns a new Bitmark address for receiving payments.\n"
...
Value getaccountaddress(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "\nReturns the current Bitmark address for receiving payments to this account.\n"
            "\nArguments:\n"
...
Value getrawchangeaddress(const Array& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "getrawchangeaddress\n"
            "\nReturns a new Bitmark address, for receiving change.\n"
...
Value sendtoaddress(const Array& params, bool fHelp)
{
    ...
    Mark default_mark1 = {std::vector<uchar>(),std::vector<uchar>(),std::vector<uchar>(),std::vector<uchar>(),std::vector<uchar>(),std::vector<uchar>(),std::vector<uchar>(),std::vector<uchar>(),std::vector<uchar>(),std::vector<uchar>()};
      
    
    string strError = pwalletMain->SendMoneyToDestination(address.Get(), nAmount, wtx, default_mark1);
    if (strError != "")
...
Value encryptwallet(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "wallet encrypted; Bitmark server stopping, restart to run with encrypted wallet. The keypool has been flushed, you need to make a new backup.";
}
