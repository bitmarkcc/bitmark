...
static const CRPCConvertParam vRPCConvertParams[] =
{
    ...
    { "createfeevotescript", 1, "slot" },
    { "createstakevotescript", 1, "slot" },
    { "createstakevotescript", 2, "locktime" },
    { "createpushcoderawtransaction", 0, "inputs" },
    { "createpushcoderawtransaction", 1, "outputs" },
    { "createpushcoderawtransaction", 2, "pushcode" },
    { "createpushcoderawtransaction", 3, "locktime" },
    { "createpushcoderawtransaction", 4, "replaceable" },
