 ...
 */
double GetDifficulty(const CBlockIndex& blockindex, const Consensus::Params& params = Consensus::Params(), Algo algo = Algo::UNKNOWN, bool weighted = false, bool next = false);
