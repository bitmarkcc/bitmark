...
bool static IsLowDERSignature(const valtype &vchSig) { //not needed for now so commented out last return
...
bool EvalScript(vector<vector<unsigned char> >& stack, const CScript& script, const CTransaction& txTo, unsigned int nIn, unsigned int flags, int nHashType)
{
    ...
    try
    {
		...
		case OP_NOP1:
	        ...
	        {
                    // see https://github.com/petertodd/bitcoin/commit/ab0f54f38e08ee1e50ff72f801680ee84d0f1bf4
...
bool Solver(const CScript& scriptPubKey, txnouttype& typeRet, vector<vector<unsigned char> >& vSolutionsRet)
{
  //LogPrintf("Run solver with scriptPubKey %s\n",HexStr(scriptPubKey));
    ...
    if (mTemplates.empty())
    {
        ...
        // Bitmark address tx, sender provides hash of pubkey, receiver provides signature and pubkey
