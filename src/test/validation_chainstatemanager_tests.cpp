...
struct SnapshotTestSetup : TestChain100Setup {
    ...
    std::tuple<Chainstate*, Chainstate*> SetupSnapshot()
    {
        ...
        // be found.
        constexpr int snapshot_height = 730;
        mineBlocks(10);
        initial_size += 10;
...
//!
BOOST_FIXTURE_TEST_CASE(chainstatemanager_loadblockindex, TestChain100Setup) // todo: fix for BTM
{
    ...
    const int last_assumed_valid_idx{731};
    ...
    BOOST_CHECK_EQUAL(validated_tip->nHeight, 710); // current cs1 chain has height 90
    BOOST_CHECK_EQUAL(assumed_base->nHeight, 730); // current cs2 chain has height 110
...
BOOST_FIXTURE_TEST_CASE(chainstatemanager_snapshot_init, SnapshotTestSetup)
{
    ...
    BOOST_CHECK_EQUAL(bg_chainstate.m_chain.Height(), 729);
...

    {
        ...
        BOOST_CHECK_EQUAL(chainman_restarted.ActiveHeight(), 830);
    }
    ...
    {
        LOCK(chainman_restarted.GetMutex());
        BOOST_CHECK_EQUAL(chainman_restarted.ActiveHeight(), 840);
